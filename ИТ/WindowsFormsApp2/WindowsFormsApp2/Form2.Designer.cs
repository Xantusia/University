namespace WindowsFormsApp2
{
    partial class Form2
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.label1.Text = "Введите ряд чисел (дробные числа писать через запятую), используя в качестве разд" +
    "елителя пробел";
            ...
            this.label2.Text = "Нажмите кнопку ниже, чтобы найти наименьшее и наибольшее числа";
            // 
            // Form2
            // 
